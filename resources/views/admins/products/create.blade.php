    ...
    <div class="bg-white border rounded-5 shadow-3 overflow-hidden">
        ...
        <form method="post" action="{{route('admin.products.store')}}" enctype="multipart/form-data"
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    ...
                    <div data-mdb-input-init class="p-3 pb-0 d-flex align-items-center justify-content-between">
                        <label class="me-3 w-25" for="name">Product name</label>
                    ...
                    <!-- price input -->
                    <div data-mdb-input-init class="p-3 pb-0 d-flex align-items-center justify-content-between">
                        <label class="me-3 w-25" for="price">Price</label>
                    ...
                    <!-- quantity input -->
                    <div data-mdb-input-init class="p-3 pb-0 d-flex align-items-center justify-content-between">
                        <label class="me-3 w-25" for="quantity">Quantity</label>
                    ...
                    <!-- description input -->
                    <div data-mdb-input-init class="p-3 pb-0 d-flex align-items-center justify-content-between">
                        <label class="me-3 w-25" for="description">Description</label>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div data-mdb-input-init class="p-3 pb-0 d-flex align-items-center">
                        ...
                        <select name="age_id" id="age" class="form-select">
                            @foreach($ages as $age)
            ...
            <div class="d-flex justify-content-between justify-content-md-start border-top p-3">
                ...
                <!-- Submit button -->
                <button data-mdb-ripple-init class="btn btn-primary rounded-9 tran-2">
                    Save
                </button>
            </div>
        </form>
